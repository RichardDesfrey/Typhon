...
Table_Hooks:
      ...
      Hook 74C82Ah, CallTrigger,		  TCall; хук на все триггеры
      ...
      Hook 766A8Dh, Block,			  TJump; Блок удара (Драколич)
      Hook 5A40C1h, Animate_Dead1,		  TJump; Воскрешение мертвецов
      Hook 5A4029h, Animate_Dead2,		  TJump; Воскрешение мертвецов
      Hook 440924h, Animate_Dead3,		  TJump; Воскрешение мертвецов
      Hook 44A29Ch, Animate_Dead4,		  TJump; Воскрешение мертвецов
...
ChangeNumMon = $
   dd 756410h, 7504F8h, 732CA9h, 733326h, 726511h, 71B02Dh, 718153h, 71A9F8h, 723B66h, 721818h, 723973h, 723D58h, 726127h, 726177h, 726366h, 7263D0h,\
      ...
      7614E0h, 76B2DEh, 7183FCh, 4A1657h, 4A189Ch, 40C2B1h, 43FE26h, 44192Fh, 479143h, 4925BFh, 49295Ah, 4A6A7Fh, 4A6C98h, 4DBA62h, 4F5BD2h, 5213E6h,\
...
Block_mop db 'EraPlugins\MCrEdit\Block.mop', 0
